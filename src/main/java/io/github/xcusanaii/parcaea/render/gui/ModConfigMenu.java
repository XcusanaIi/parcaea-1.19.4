        ...
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.createBuilder(Integer.class)
                                        .name(Text.literal("Name Color"))
                                        .binding(ModConfig.Colors.AQUA, () -> Parcaea.getConfig().labels.x.colorKey, newVal -> Parcaea.getConfig().labels.x.colorKey = newVal)
                                        .controller(IntegerFieldController::new)
                                        .build())
                                .option(Option.createBuilder(Integer.class)
                                        .name(Text.literal("Value Color"))
                                        .binding(ModConfig.Colors.WHITE, () -> Parcaea.getConfig().labels.x.colorValue, newVal -> Parcaea.getConfig().labels.x.colorValue = newVal)
                                        .controller(IntegerFieldController::new)
                                        .build())
                                .option(Option.createBuilder(Integer.class)
                                        .name(Text.literal("DecimalCount"))
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.createBuilder(Integer.class)
                                        .name(Text.literal("Name Color"))
                                        .binding(ModConfig.Colors.AQUA, () -> Parcaea.getConfig().labels.y.colorKey, newVal -> Parcaea.getConfig().labels.y.colorKey = newVal)
                                        .controller(IntegerFieldController::new)
                                        .build())
                                .option(Option.createBuilder(Integer.class)
                                        .name(Text.literal("Value Color"))
                                        .binding(ModConfig.Colors.WHITE, () -> Parcaea.getConfig().labels.y.colorValue, newVal -> Parcaea.getConfig().labels.y.colorValue = newVal)
                                        .controller(IntegerFieldController::new)
                                        .build())
                                .option(Option.createBuilder(Integer.class)
                                        .name(Text.literal("DecimalCount"))
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.createBuilder(Integer.class)
                                        .name(Text.literal("Name Color"))
                                        .binding(ModConfig.Colors.AQUA, () -> Parcaea.getConfig().labels.z.colorKey, newVal -> Parcaea.getConfig().labels.z.colorKey = newVal)
                                        .controller(IntegerFieldController::new)
                                        .build())
                                .option(Option.createBuilder(Integer.class)
                                        .name(Text.literal("Value Color"))
                                        .binding(ModConfig.Colors.WHITE, () -> Parcaea.getConfig().labels.z.colorValue, newVal -> Parcaea.getConfig().labels.z.colorValue = newVal)
                                        .controller(IntegerFieldController::new)
                                        .build())
                                .option(Option.createBuilder(Integer.class)
                                        .name(Text.literal("DecimalCount"))
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.createBuilder(Integer.class)
                                        .name(Text.literal("Name Color"))
                                        .binding(ModConfig.Colors.AQUA, () -> Parcaea.getConfig().labels.facing.colorKey, newVal -> Parcaea.getConfig().labels.facing.colorKey = newVal)
                                        .controller(IntegerFieldController::new)
                                        .build())
                                .option(Option.createBuilder(Integer.class)
                                        .name(Text.literal("Value Color"))
                                        .binding(ModConfig.Colors.WHITE, () -> Parcaea.getConfig().labels.facing.colorValue, newVal -> Parcaea.getConfig().labels.facing.colorValue = newVal)
                                        .controller(IntegerFieldController::new)
                                        .build())
                                .option(Option.createBuilder(Integer.class)
                                        .name(Text.literal("DecimalCount"))
